...
class Net:
    ...
    def predict(self, img, display_img,target_object, predicted_results):
        ...
        with self.graph.as_default():
            ...
            for i in range(0, int(num_detections)):
                ...
                if score >= self.threshold:
                    ...
                    #print('[INFO] %s:' % (predicted_class))
                    #print('[Targer_object] %s:' % (target_object))
                    if predicted_class in target_object:
                        print('[True] %s: %s' % (predicted_class, score))
