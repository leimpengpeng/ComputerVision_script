...
if __name__ == '__main__':
  ...
  #im = cv2.imread('zbar-test.jpg')
          ...
          #cv2.imshow("Results", cv2.resize(im_barcode,(800,600,3)));

          cv2.imwrite(os.path.join(output_dir,'im_proc','im_proc{}.jpg'.format(index)),im_barcode)# cv2.cvtColor(image_np) #, cv2.COLOR_RGB2BGR))
          index = index + 1
